...
ArcsimSportsCar::ArcsimSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UrcsimSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UrcsimSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UrcsimSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UrcsimSportsWheelRear::StaticClass();
